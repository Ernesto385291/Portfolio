...
/** "26 de enero del 2021" -> "JAN 26, 2021" (falls back to the raw string) */
...
export function readingTime(markdown: string, wordsPerMinute = 200) {
  return Math.max(1, Math.round(wordCount(markdown) / wordsPerMinute));
}
